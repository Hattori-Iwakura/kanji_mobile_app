...
// in kanji_flutter/test/features/auth/services/auth_service_test.dart.
...
import 'package:kanji_flutter/core/network/api_client.dart' as _i3;
import 'package:kanji_flutter/features/auth/services/auth_storage.dart' as _i5;
...
class MockApiClient extends _i1.Mock implements _i3.ApiClient {
  ...
  @override
  _i4.Future<_i2.Response<dynamic>> patch(String? path, dynamic data) =>
      (super.noSuchMethod(
...
class MockAuthStorage extends _i1.Mock implements _i5.AuthStorage {
  ...
  @override
  _i4.Future<int?> getUserIdFromToken() =>
      (super.noSuchMethod(
            Invocation.method(#getUserIdFromToken, []),
